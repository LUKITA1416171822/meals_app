  ...
  return Scaffold(
    ...
    actions: [
      IconButton(onPressed:()
          {final wasAdded=ref.read(favoriteMealsProvider.notifier).toggleMealFavorite(meal);
          ...
          icon: AnimatedSwitcher(
            ...
            transitionBuilder: (child, animation){
               return RotationTransition(turns: Tween<double>(
                 begin:0.5,end:1.0).animate(animation)
               ,child: child );
            },
          ),)
    ],
    ),
    body:SingleChildScrollView(child: Column(children: [ Hero(tag: meal.id, child:Image.network(meal.imageUrl,
